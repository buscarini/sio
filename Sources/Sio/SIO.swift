...
public final class Work<E, A> {
	public typealias ErrorCallback = (E) -> ()
	public typealias ResultCallback = (A) -> ()
	public typealias EmptyCallback = () -> ()

//	public typealias Async = (@escaping ErrorCallback, @escaping ResultCallback) -> ()
	public typealias Async = () -> Void
	
	public var onCancel: EmptyCallback?
	
	@usableFromInline
	var implementation: Async
...
//	var implementation: Implementation
	...
	@usableFromInline
	var work: (R, @escaping ErrorCallback, @escaping ResultCallback) -> Work<E, A>
...
//	}
	...
	public init(_ async: @escaping Async) {
		self.work = { r, reject, resolve in
			Work<E, A>(
				{
					async(r, reject, resolve)
				},
				cancel: nil
			)
		}
...
//		self._cancel = nil
	...
	public init(
		work: @escaping (R, @escaping ErrorCallback, @escaping ResultCallback) -> Work<E, A>
	) {
		self.work = work
	}
...
//	}
	...
	public func fork(
		...
		self.work(requirement, reject, resolve)
